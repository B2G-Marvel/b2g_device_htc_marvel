...
$(call inherit-product, device/htc/marvel/msm7x27-common/msm7x27.mk)
...
PRODUCT_COPY_FILES += \
 ...
 ### Wi-fi
PRODUCT_COPY_FILES += \
     device/htc/marvel/system/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
     device/htc/marvel/system/etc/wifi/hostapd.conf:system/etc/wifi/hostapd.conf
...
$(call inherit-product-if-exists, vendor/marvel/marvel-vendor.mk)
