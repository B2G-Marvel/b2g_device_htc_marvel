...
CameraHAL_FixupParams(android::CameraParameters &settings)
{
   const char *preview_sizes =
      "640x480,384x288,352x288,320x480,320x240,240x160,176x144";
   const char *video_sizes =
      "640x480,384x288,352x288,320x480,320x240,240x160,176x144";
   const char *preferred_size = "320x480";
   const char *preview_frame_rates = "25,24,23,22,21,20,19,18,17,16,15";
